...
public class HibernateDaoSample {

	public static void main(String[] args) {
		ApplicationContext ctx = new ClassPathXmlApplicationContext("beans-hibernate.xml");
		StudentDao studentDao = (StudentDao) ctx.getBean("hibStudentDao");
